...
async function initDB() {
  ...
  `);
  // Custos amarrados a um veiculo especifico (Central de Custos do carro).
  // Referenciada nas rotas /stock-cost; garantimos a existencia aqui pra
  // bancos novos subirem completos.
  await pool.query(`
